...
public class HazardDTOComparator implements Comparator<HazardDTO> {

    @Override
    public int compare(HazardDTO o1, HazardDTO o2) {
    ...
    private int compareByToxvalType(HazardDTO o1, HazardDTO o2) {
        return compare(o1.getToxvalType(), o2.getToxvalType());
    }

    // todo: really need to change toxval-numeric to a double type :(
    private int compareByToxvalNumeric(HazardDTO o1, HazardDTO o2) throws NumberFormatException {
    ...
    public static int compareBySuperCategory(HazardDTO o1, HazardDTO o2) {
